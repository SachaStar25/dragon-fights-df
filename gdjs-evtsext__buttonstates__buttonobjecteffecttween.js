...
gdjs.evtsExt__ButtonStates__ButtonObjectEffectTween.ButtonObjectEffectTween = class ButtonObjectEffectTween extends gdjs.RuntimeBehavior {
  ...
  updateFromBehaviorData(oldBehaviorData, newBehaviorData) {
    ...
    if (oldBehaviorData.ShouldDisableEffectInIdle !== newBehaviorData.ShouldDisableEffectInIdle)
      this._behaviorData.ShouldDisableEffectInIdle = newBehaviorData.ShouldDisableEffectInIdle;
